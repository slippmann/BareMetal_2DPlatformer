...
HD_PWD='C:/Users/slippman/DonkeyKong/DonkeyKong.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log donkey_kong_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source donkey_kong_wrapper.tcl -notrace

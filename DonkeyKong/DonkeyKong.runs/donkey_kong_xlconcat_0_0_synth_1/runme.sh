...
HD_PWD='C:/Users/slippman/DonkeyKong/DonkeyKong.runs/donkey_kong_xlconcat_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log donkey_kong_xlconcat_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source donkey_kong_xlconcat_0_0.tcl

...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib fifo_generator_v13_2_0)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb donkey_kong.wdb xsim.dir)

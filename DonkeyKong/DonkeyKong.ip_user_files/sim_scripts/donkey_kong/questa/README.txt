...
#
# Generated by export_simulation on Wed Mar 07 18:43:03 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './donkey_kong.sh' script.

./donkey_kong.sh -reset_run
...
./donkey_kong.sh -noclean_files

For more information on the script, please type './donkey_kong.sh -help'.

...
################################################################
# This is a generated script based on design: donkey_kong
#
...
proc create_root_design { parentCell } {
  ...
  set Button [ create_bd_port -dir I -from 6 -to 0 Button ]
  ...
  if { [catch {set Debouncer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
   ...
   CONFIG.NUM_SIGNALS {7} \
 ] $Debouncer_0

  # Create instance: axi_audio_codec_0, and set properties
  set axi_audio_codec_0 [ create_bd_cell -type ip -vlnv sfu.ca:user:axi_audio_codec:1.0 axi_audio_codec_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins AXI_VGA_0/S00_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_audio_codec_0/S00_AXIS] [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S]
  ...
  connect_bd_net -net AC_GPIO1_0_1 [get_bd_ports AC_GPIO1_0] [get_bd_pins axi_audio_codec_0/AC_GPIO1]
  connect_bd_net -net AC_GPIO2_0_1 [get_bd_ports AC_GPIO2_0] [get_bd_pins axi_audio_codec_0/AC_GPIO2]
  connect_bd_net -net AC_GPIO3_0_1 [get_bd_ports AC_GPIO3_0] [get_bd_pins axi_audio_codec_0/AC_GPIO3]
  connect_bd_net -net AXI_VGA_0_BLUE [get_bd_ports BLUE] [get_bd_pins AXI_VGA_0/BLUE]
  connect_bd_net -net AXI_VGA_0_GREEN [get_bd_ports GREEN] [get_bd_pins AXI_VGA_0/GREEN]
  connect_bd_net -net AXI_VGA_0_H_SYNC [get_bd_ports H_SYNC] [get_bd_pins AXI_VGA_0/H_SYNC]
  connect_bd_net -net AXI_VGA_0_RED [get_bd_ports RED] [get_bd_pins AXI_VGA_0/RED]
  connect_bd_net -net AXI_VGA_0_V_SYNC [get_bd_ports V_SYNC] [get_bd_pins AXI_VGA_0/V_SYNC]
  connect_bd_net -net Debouncer_0_BTN_OUT [get_bd_pins Debouncer_0/BTN_OUT] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net GPIO_1 [get_bd_ports Button] [get_bd_pins Debouncer_0/BTN_IN]
  connect_bd_net -net Net [get_bd_ports AC_SDA_0] [get_bd_pins axi_audio_codec_0/AC_SDA]
  connect_bd_net -net axi_audio_codec_0_AC_ADR0 [get_bd_ports AC_ADR0_0] [get_bd_pins axi_audio_codec_0/AC_ADR0]
  connect_bd_net -net axi_audio_codec_0_AC_ADR1 [get_bd_ports AC_ADR1_0] [get_bd_pins axi_audio_codec_0/AC_ADR1]
  connect_bd_net -net axi_audio_codec_0_AC_GPIO0 [get_bd_ports AC_GPIO0_0] [get_bd_pins axi_audio_codec_0/AC_GPIO0]
  connect_bd_net -net axi_audio_codec_0_AC_MCLK [get_bd_ports AC_MCLK_0] [get_bd_pins axi_audio_codec_0/AC_MCLK]
  connect_bd_net -net axi_audio_codec_0_AC_SCK [get_bd_ports AC_SCK_0] [get_bd_pins axi_audio_codec_0/AC_SCK]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_mm2s_prmry_reset_out_n [get_bd_pins AXI_VGA_0/s00_axis_aresetn] [get_bd_pins axi_dma_0/mm2s_prmry_reset_out_n]
  connect_bd_net -net axi_dma_1_mm2s_introut [get_bd_pins axi_dma_1/mm2s_introut] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net axi_dma_1_mm2s_prmry_reset_out_n [get_bd_pins axi_audio_codec_0/s00_axis_aresetn] [get_bd_pins axi_dma_1/mm2s_prmry_reset_out_n]
  connect_bd_net -net axi_gpio_0_ip2intc_irpt [get_bd_pins axi_gpio_0/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_VGA_0/s00_axis_aclk] [get_bd_pins Debouncer_0/CLK] [get_bd_pins axi_audio_codec_0/s00_axis_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

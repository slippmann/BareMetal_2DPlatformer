...
#define SPEAR_ADDR					(FIRE_1_ADDR + 404)					// size(bytes): 796
#define SAW_ADDR					(SPEAR_ADDR + 796)					// size(bytes): 796
#define SANS_STILL_ADDR				(SAW_ADDR + 796)					// size(bytes): 1540
...
#define PAPYRUS_END_DIALOG_0_ADDR	(PAPYRUS_DIALOG_4_ADDR + 25604)			// size(bytes): 25604
#define PAPYRUS_END_DIALOG_1_ADDR	(PAPYRUS_END_DIALOG_0_ADDR + 25604)		// size(bytes): 25604
#define PAPYRUS_END_DIALOG_2_ADDR	(PAPYRUS_END_DIALOG_1_ADDR + 25604)		// size(bytes): 25604
#define PAPYRUS_END_DIALOG_3_ADDR	(PAPYRUS_END_DIALOG_2_ADDR + 25604)		// size(bytes): 25604
#define PAPYRUS_END_DIALOG_4_ADDR	(PAPYRUS_END_DIALOG_3_ADDR + 25604)		// size(bytes): 25604
#define PAPYRUS_END_DIALOG_5_ADDR	(PAPYRUS_END_DIALOG_4_ADDR + 25604)		// size(bytes): 25604
#define PAPYRUS_END_DIALOG_6_ADDR	(PAPYRUS_END_DIALOG_5_ADDR + 25604)		// size(bytes): 25604

// Win
#define WIN_BACKGROUND				(PAPYRUS_END_DIALOG_6_ADDR + 25604)		// size(bytes):	614404
#define SLEEP_DOG_0_ADDR			(WIN_BACKGROUND + 614404)				// size(bytes):	8532
#define SLEEP_DOG_1_ADDR			(SLEEP_DOG_0_ADDR + 8532)				// size(bytes):	8532

// Misc.
#define HEART_ADDR					(SLEEP_DOG_1_ADDR + 8532)				// size(bytes): 652
#define NUMBERS_ADDR				(HEART_ADDR + 652)						// size(bytes): 4324

// Song
#define SHARED_MEM_ADDR				(0x12000000)

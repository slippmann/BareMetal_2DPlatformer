...
static struct sprite trap_fire_3;
...
void InitTraps()
{
	...
	//========= level 4 traps ==========
	trap_fire_2.img = fire_0_img;
	trap_fire_2.dim.width = 10;
	...
	trap_fire_3.img = fire_1_img;
	trap_fire_3.dim.width = 10;
	trap_fire_3.dim.height = 18;
	trap_fire_3.pos.x = trap_fire_2.pos.x - trap_fire_3.dim.width - 8;
	trap_fire_3.pos.y = platform_lvl4.pos.y - trap_fire_3.dim.height;
	trap_fire_3.type = MOB;
	...
	traps[4][1] = &trap_fire_3;
	traps[4][2] = &trap_spear_3;
}
...
void UpdateSprites(void * param)
{
	...
	trap_fire_3.img = trap_fire_3.img == fire_0_img ? fire_1_img : fire_0_img;
